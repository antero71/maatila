 ...
 */
public class KeraaLeivatVarastoon implements Komento{

    private Maatila maatila;

    public KeraaLeivatVarastoon(Maatila maatila) {
    ...
    @Override
    public void suorita() {
        maatila.keraaLeivatVarastoon();
    }

    @Override
    public String tulosta() {
        return "kerää leivät varastoon";
    }
